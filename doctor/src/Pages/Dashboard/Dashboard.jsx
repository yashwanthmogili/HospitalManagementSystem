...
export default function NewHeader({ handleIsLogin }) {
    ...
    <Box sx={{ display: "flex", background: "#F6F6F6" }}>
      ...
      >
        ...
        <List>
          ...
          <ListItem>
            <ListItemIcon>
              <MdLogout style={{ color: "#000", fontSize: "1.4rem" }} />
            </ListItemIcon>
            <ListItemText onClick={()=>handleIsLogin(false)}  primary="Logout" style={{ marginLeft: "-.1rem",cursor:"pointer"}} />
          </ListItem>
        </List>
      </Drawer>
      <Main open={open}>
